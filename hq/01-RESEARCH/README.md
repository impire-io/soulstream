...
recording the investigation as it happens, plus whatever documents or rigs
the work produces.
...
/research-start <slug>            state: active
  ...
  experiments/rigs → honest verdict; scratchpad for throwaway
...
/research-graduate <slug> --to design | artifact | abandoned
        ...
        ├─ artifact: the deliverable itself ships (rig, tool, doc)
